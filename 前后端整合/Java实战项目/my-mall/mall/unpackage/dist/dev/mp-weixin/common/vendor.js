...
// easier to handle this case. if(!global) { ...}
  ...
  \*************************************************************/
        ...
        (function (uni) {
            ...
            var
                I18n = /*#__PURE__*/function () {
                    function I18n(_ref3) {
                        var locale = _ref3.locale, fallbackLocale = _ref3.fallbackLocale, messages = _ref3.messages,
                            watcher = _ref3.watcher, formater = _ref3.formater;
    ...
    /* 5 */
    /*!************************************************************!*\
  !*** D:/Programs/Git/mygit/前后端整合/Java实战项目/mall/pages.json ***!
  \************************************************************/
    /*! no static exports found */
    /***/ (function (module, exports) {
...
// be included in the final webpack user bundle.
    ...
    /* 18 */
    /*!***************************************************************!*\
  !*** D:/Programs/Git/mygit/前后端整合/Java实战项目/mall/common/api.js ***!
  \***************************************************************/
    /*! no static exports found */
    /***/ (function (module, exports) {
...
// 导出以用于全局使用 module.exports (Json Object)
    ...
    /* 19 */
    /*!****************************************************************!*\
  !*** D:/Programs/Git/mygit/前后端整合/Java实战项目/mall/common/util.js ***!
  \****************************************************************/
    /*! no static exports found */
    /***/ (function (module, exports, __webpack_require__) {

        /* WEBPACK VAR INJECTION */
        (function (uni) {// 注: js代码参照从上至下执行顺序 否则报错
// 声明对象
            var utils = {
                // 服务器域名
                ...
                request: function request(url) {
                    ...
                    var contentType = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : "application/x-www-form-urlencoded";
                    var isDelay = arguments.length > 4 ? arguments[4] : undefined;
                    var hideLoading = arguments.length > 5 ? arguments[5] : undefined;
                    var loadding = false;
                            ...
                            success: function success(res) {
                                ...
                                if (res.statusCode === 200) {
                                    if (res.data.errno === 401) {
                                        // 弹窗提示,并跳转到登录
                                        utils.modal('温馨提示', '您还没有登录，是否去登录', true, function (confirm) {
                                            if (confirm) {
                                                // 重定向到登录认证页
                                                uni.redirectTo({
