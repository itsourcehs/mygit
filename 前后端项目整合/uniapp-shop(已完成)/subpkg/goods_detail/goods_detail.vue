...
// 商品信息区域样式
.goods-info-box {padding: 10px;padding-right: 0;}
.price {color: #c00000;font-size: 18px;margin: 10px 0;}
.goods-info-body {display: flex;justify-content: space-between;}
.goods-name {font-size: 13px;padding-right: 10px;}
.favi {
	width: 120px;
	font-size: 12px;
	display: flex;
...
// 商品导航区域样式
.goods-detail-container {padding-bottom: 50px;}
