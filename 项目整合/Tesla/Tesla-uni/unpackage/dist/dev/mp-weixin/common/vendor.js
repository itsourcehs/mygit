...
/***/ 59:
/*!*******************************************************************************************!*\
  !*** C:/Users/Administrator/IdeaProjects/HelloWorld/项目整合/Tesla/Tesla-uni/common/utils.js ***!
  \*******************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.default = timeFormat; // 时间日期格式化
function timeFormat() {
  var date = new Date();
  ...
  var hours = date.getHours().toString().padStart(2, "0"); // 时
  var min = date.getMinutes().toString().padStart(2, "0"); // 分
  var sec = date.getSeconds().toString().padStart(2, "0"); // 秒
