...
/* WEBPACK VAR INJECTION */(function(uni) {// 导出以用于全局使用 module.exports (Json Object)
module.exports = {
...
var utils = {
  ...
  interfaceUrl: function interfaceUrl() {return utils.domain + 'platform/api/';},
  ...
  // 获取token
  getToken: function getToken() {return uni.getStorageSync("X-Nideshop-Token");} };
